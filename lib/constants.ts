...
export const SMS_TEMPLATES = [
  {
    label: "방문 예정 통보",
    body: "안녕하세요, 국세외수입 체납관리단입니다. {날짜} {시간}에 방문 예정임을 알려드립니다.",
  },
  {
    label: "납부 안내",
    body: "안녕하세요, 국세외수입 체납관리단입니다. 체납액 납부 안내드립니다. 문의사항은 연락 부탁드립니다.",
  },
  {
    label: "재방문 일정 통보",
    body: "안녕하세요, 국세외수입 체납관리단입니다. {날짜} {시간}에 재방문 예정입니다. 확인 부탁드립니다.",
  },
  {
    label: "직접 작성",
    body: "",
